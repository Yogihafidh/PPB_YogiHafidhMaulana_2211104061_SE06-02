  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor: Colors.white, // Warna header
      ),
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            ...
            child: ListTile(
              ...
              leading: Container(
                color: Colors.white, // Background foto produk
                child: Image.network(
                  product.gambarUrl,
                  width: 70,
                  height: 70,
              ...
              title: Text(
                product.nama,
                style: TextStyle(color: Colors.black), // Teks judul produk
              ),
              subtitle: Column(
                ...
                children: [
                  Text(
                    'Rp${product.harga}',
                    style: TextStyle(color: Colors.black), // Teks harga
                  ),
                  Text(
                    product.deskripsi,
                    style:
                        TextStyle(color: Colors.black), // Teks deskripsi produk
                  ),
                ],
              ),
              onTap: () {
